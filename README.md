...
| OnDataAdded      | Triggered after new data has been inserted.                             | System & User | insertData()         | System: engine, insertedDocs (Pipeline*)<br>User: insertedIds (or the version modified by the system)                                    | 
